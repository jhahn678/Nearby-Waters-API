...
export type StateName =
    'Arkansas'| 'District of Columbia'| 'Delaware'| 'Florida'| 'Georgia'| 'Kansas'| 'Louisiana'| 
    'Maryland'| 'Missouri'| 'Mississippi'| 'North Carolina'| 'Oklahoma'| 'South Carolina'| 
    'Tennessee'| 'Texas'| 'West Virginia'| 'Alabama'| 'Connecticut'| 'Iowa'| 'Illinois'| 'Indiana'| 
    'Maine'| 'Michigan'| 'Minnesota'| 'Nebraska'| 'New Hampshire'| 'New Jersey'| 'New York'| 'Ohio'| 
